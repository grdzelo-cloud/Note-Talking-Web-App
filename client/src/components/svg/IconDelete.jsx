export default function IconDelete({stroke, className}) {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="25" fill="none" className={className} viewBox="0 0 24 25">
