export default function IconSearch({stroke, className}) {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" className={className} viewBox="0 0 24 24">
            <path className={stroke || 'fill-slate-950'} fillRule="evenodd"
                  ...
                  clipRule="evenodd"/>
            <path className={stroke || 'fill-slate-950'} fillRule="evenodd" d="m16.736 15.648 5.616 5.6-1.06 1.063-5.615-5.601 1.06-1.062Z"
                  clipRule="evenodd"/>
        </svg>
    )
}