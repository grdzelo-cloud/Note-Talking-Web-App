    ...
    return (<>
            <div
                ...
                <div className="w-full h-full p-2 fixed absolute-center">
                    <div
                        className={`${!isOpen ? "scale-95 opacity-0 cursor-none" : "scale-100 opacity-100"} transition-all duration-150 absolute-center h-fit w-full lg:max-w-[440px] sm:max-w-[343px] max-w-[300px] bg-neutral-0 border-neutral-200 border-1 rounded-12  flex gap-4 text-preset-3  items-start`}>
                        <div className="w-full ">
                            <div>
                                <div className="flex items-start gap-4 p-250">
                                    <div className="rounded-8 p-100 bg-neutral-100">
                                ...
                                <Separator/>
                                <div
                                    className="flex w-full justify-end gap-200 py-200 px-250">
                                    <div
                                        onClick={(e) => handleClose(e)}
                                    >
                                        <Button
                                            type="button"
                                            variant={"secondary"}>{variant === "delete" ? modalConstants[0].cancelButtonText : modalConstants[1].cancelButtonText}</Button>
                                    </div>
                                    <div
                                    ...
                                    >
                                        <Button
                                            ...
                                            {/*{(<IconRestore className={"animate-spin"} stroke={"fill-white"}/>)}*/}
